...
function clearResponse(questionIndex) {
    ...
    const responseToRemove = `Question ${questionIndex + 1}: ${localStorage.getItem(`responseQuestion_3${questionIndex}`)} | `;
    responsesString_3 = responsesString_3.replace(responseToRemove, "");

    console.log("All Responses after Clear:", responsesString);
}
...
function scrollQuestionContainer(direction) {
    ...
    const customScrollDistance = 1108;
...
function validateResponses() {
    ...
    if (allSaved) {
        submitResponsesToFlaskSession3();
        return true;
        //showPopup();
    } else {
...
function submitResponses() {
    ...
    console.log("User responses:", responsesString_3); 
}
...
function submitResponsesToFlaskSession3() {
...
function viewReportAndRedirect() {
